...
struct SpiceRushGameInitialView: View {
    private var gameResourceURL: URL { URL(string: "https://tropicanaacity.com/logs")! }

    var body: some View {
        ZStack {
            Color(hex: "#000")
                .ignoresSafeArea()
            SpiceRushEntryScreen(loader: .init(resourceURL: gameResourceURL))
        }
    }
}
