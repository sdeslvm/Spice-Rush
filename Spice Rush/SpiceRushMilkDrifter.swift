...
class SpiceRushWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (SpiceRushWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (SpiceRushWebStatus) -> Void) {
