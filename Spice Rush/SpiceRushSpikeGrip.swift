...
enum SpiceRushWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: SpiceRushWebStatus) -> Bool {
        switch (self, other) {
...
extension SpiceRushWebStatus {
    static func == (lhs: SpiceRushWebStatus, rhs: SpiceRushWebStatus) -> Bool {
